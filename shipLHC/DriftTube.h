...
//  April 2025
//
#ifndef SHIPLHC_DRIFTTUBE_H_
#define SHIPLHC_DRIFTTUBE_H_

#include "FairDetector.h"
#include "Rtypes.h" // for ShipMuonShield::Class, Bool_t, etc
#include "TLorentzVector.h"

class DriftTubePoint;
class FairVolume;
class TVector3;
class TClonesArray;

class DriftTube : public FairDetector {
public:
    ...
    */
   DriftTubePoint *AddHit(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom, Double_t time, Double_t length,
   ...
   DriftTube &operator=(const DriftTube &);
